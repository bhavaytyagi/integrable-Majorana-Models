#!/usr/bin/env python3
"""Exact check for the solved N=4 Majorana Hamiltonian family."""

from __future__ import annotations

from hamfam.models import failure_counts, integrability_failures, n4_majorana_table


def main() -> int:
    _, matrix = n4_majorana_table()
    failures = integrability_failures(matrix, ("t", "eps", "eta", "zeta"))

    print("N=4 Majorana fourth-flow check")
